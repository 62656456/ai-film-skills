...
flowchart TB
    ...
    D --> V["按需选择视觉风格<br/>赛博朋克·史诗·奇幻·恐怖·黑色<br/>爱情·战争·武侠·仙侠·硬科幻·古风"]
    ...
    B --> P["一条融合六段镜头母稿<br/>第六段镜头时间轴·十项内部核对"]
...
| 分镜与提示词 | 可用剧本、导演决定和所需资产 | 一条融合六段母稿；第六段镜头时间轴，数字10内部覆盖 | 具体镜头、调度、时长或连续性问题 |
...
计数口径：本仓库分发 **18项常规＋3项实验＝21个模块**，其中20项用于影视、1项用于网页。工作流另列外部仙侠技能，因此是 **21项影视职责＋1项网页辅助**；外部仙侠不计入本仓库21个模块、42份双语指南或ZIP。

| # | Skill | 职责与交付 | 分发/使用边界 |
|---|---|---|---|
| 1 | [director-agent](skills/zh-CN/director-agent.md) | 剧本创作、编辑、诊断；导演方案；明确需要时另编译AI执行剧本 | 常规；已有批准导演方案不重新导演 |
| 2 | [ai-storyboard-director](skills/zh-CN/ai-storyboard-director.md) | 5.6.4分镜、摄影设计、融合六段母稿、作品内保存与恢复 | 当前源码5.6；不等于旧Release ZIP已更新 |
...
| 18 | [ai-short-drama-production](skills/zh-CN/ai-short-drama-production.md) | 短剧节拍、资产、调度、光线、动作与QC控制合同 | 2026-09-07按5.6.0结构建立独立交付合同，保留五列分镜＋六模块；未随5.6.4改为融合单稿，未部署、实片待验证 |
...
| 21 | [guofeng-visual-director](skills/zh-CN/guofeng-visual-director.md) | 古风文化、空间、人物器物、构图光色与完整图像提示词 | 候选实验包；不自动视为历史准确还原 |
| 辅助 | [web-design-director](skills/zh-CN/web-design-director.md) | 作品站、资产库、工作台和网页展示 | 只用于明确网页或应用界面任务；仓库README维护不触发建站 |

十一种视觉路线＝八项常规类型＋实验硬科幻＋外部仙侠＋古风候选。选择取决于作品，不要求一次加载十一项，也不把风格名变成统一色表或固定镜头。
