# epic-design｜史诗尺度与奇观参数

| 状态 | 已部署 |
|---|---|
| 单独可交付 | 史诗尺度 `style_route`、场景与运动参数、负向约束和 QC 合同。 |
| 单独不能声称 | 不能只靠大远景让尺度可信，也不能用奇观替代故事代价。 |

[运行正文 `SKILL.md`](../../../skills/epic-design/SKILL.md) · [v1.3.0 历史 ZIP](https://github.com/62656456/ai-film-skills/releases/download/v1.3.0/epic-design.zip) · [安装说明](../../INSTALLATION.md) · [兼容说明](../../COMPATIBILITY.md) · [设计总则](../../SKILL_DESIGN_SYSTEM.md)
...
把史诗尺度转成真实人物参照、地形、阵列、分层奇观、有动机的机位距离、光影、材质和运动。
...
史诗尺度 `style_route`、场景与运动参数、负向约束和 QC 合同。
...
- [ ] 人物、地形、建筑、阵列和空气纵深共同证明尺度；群像不是复制贴图，航拍有剧情目的。
