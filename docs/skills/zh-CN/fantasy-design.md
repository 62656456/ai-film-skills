...
[运行正文 `SKILL.md`](../../../skills/fantasy-design/SKILL.md) · [独立 ZIP](https://github.com/62656456/ai-film-skills/releases/latest/download/fantasy-design.zip) · [安装说明](../../INSTALLATION.md) · [兼容说明](../../COMPATIBILITY.md) · [设计总则](../../SKILL_DESIGN_SYSTEM.md)

<!-- contract:purpose -->
## 1. 设计目的

把奇幻转成自洽世界规则、魔法因果与光源、空间行为、材质、生物、动作和连续性。
...
奇幻 `style_route`、世界与魔法提示词字段、负向约束和 QC 合同。
...
- [ ] 魔法有可见来源、规则、代价、目标和环境反馈；翅膀、身体与材质不塑料、不失重。
