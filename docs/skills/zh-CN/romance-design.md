...
[运行正文 `SKILL.md`](../../../skills/romance-design/SKILL.md) · [独立 ZIP](https://github.com/62656456/ai-film-skills/releases/latest/download/romance-design.zip) · [安装说明](../../INSTALLATION.md) · [兼容说明](../../COMPATIBILITY.md) · [设计总则](../../SKILL_DESIGN_SYSTEM.md)

<!-- contract:purpose -->
## 1. 设计目的

把爱情转成人际距离、微动作、视线、暖色实用光、亲密材质、节奏、克制和连续性。
...
爱情 `style_route`、亲密与光影参数、负向约束和 QC 合同。
...
- [ ] 距离、视线、接触、停顿和光线响应真实关系变化；柔和不抹掉动作与材质。
...
- [`agents/openai.yaml`](../../../skills/romance-design/agents/openai.yaml)
- [`SKILL.md`](../../../skills/romance-design/SKILL.md)
