...
[运行正文 `SKILL.md`](../../../skills/horror-design/SKILL.md) · [独立 ZIP](https://github.com/62656456/ai-film-skills/releases/latest/download/horror-design.zip) · [安装说明](../../INSTALLATION.md) · [兼容说明](../../COMPATIBILITY.md) · [设计总则](../../SKILL_DESIGN_SYSTEM.md)

<!-- contract:purpose -->
## 1. 设计目的

把恐怖转成威胁位置、显露时机、可读暗部、空间不确定性、物理痕迹、声音和连续性。
...
恐怖 `style_route`、显露与暗部参数、负向约束和 QC 合同。
...
- [ ] 暗部保留必要信息，威胁显露会改变理解，悬念由空间、动作、痕迹和声音建立。
