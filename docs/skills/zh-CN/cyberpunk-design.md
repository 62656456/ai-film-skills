...
[运行正文 `SKILL.md`](../../../skills/cyberpunk-design/SKILL.md) · [独立 ZIP](https://github.com/62656456/ai-film-skills/releases/latest/download/cyberpunk-design.zip) · [安装说明](../../INSTALLATION.md) · [兼容说明](../../COMPATIBILITY.md) · [设计总则](../../SKILL_DESIGN_SYSTEM.md)

<!-- contract:purpose -->
## 1. 设计目的

把赛博朋克转成有来源的人造光、城市层级、身体/技术关系、湿面反馈、材质磨损和可读连续性。
...
赛博朋克 `style_route`、提示词字段、负向约束、声音/连续状态和 QC 合同。
