...
定义人物稳定身份、多视角、表情、动作、服装、材质和允许状态变化，供下游连续性使用。
...
人物参考图任务、视图计划、锁定特征清单、负向约束和 JSON 合同。
...
- [ ] 五官、体型、发际线、服装、年龄、肢体数量、表情和所需视图保持同一身份。
...
- [`agents/openai.yaml`](../../../skills/character-asset/agents/openai.yaml)
- [`SKILL.md`](../../../skills/character-asset/SKILL.md)
