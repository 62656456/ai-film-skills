...
[Runtime `SKILL.md`](../../../skills/horror-design/SKILL.md) · [v1.3.0 historical ZIP](https://github.com/62656456/ai-film-skills/releases/download/v1.3.0/horror-design.zip) · [Install](../../INSTALLATION.md) · [Compatibility](../../COMPATIBILITY.md) · [Design system](../../SKILL_DESIGN_SYSTEM.md)
...
Translate horror into threat placement, reveal timing, readable darkness, spatial uncertainty, physical traces, sound, and continuity.
...
A horror `style_route`, reveal and darkness parameters, negative constraints, and QC contract.
...
- [ ] Dark areas preserve required information; threat reveal changes understanding; suspense is built through space, action, trace, and sound rather than empty darkness.
...
- [`agents/openai.yaml`](../../../skills/horror-design/agents/openai.yaml)
- [`SKILL.md`](../../../skills/horror-design/SKILL.md)
