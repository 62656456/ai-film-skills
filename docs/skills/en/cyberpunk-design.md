# cyberpunk-design — cyberpunk visual parameters

| Status | Deployed |
|---|---|
| Can deliver alone | A cyberpunk `style_route`, prompt fields, negative constraints, sound/continuity state, and QC contract. |
| Cannot claim alone | It does not create the story or assets and does not make multicolor neon automatically coherent. |

[Runtime `SKILL.md`](../../../skills/cyberpunk-design/SKILL.md) · [v1.3.0 historical ZIP](https://github.com/62656456/ai-film-skills/releases/download/v1.3.0/cyberpunk-design.zip) · [Install](../../INSTALLATION.md) · [Compatibility](../../COMPATIBILITY.md) · [Design system](../../SKILL_DESIGN_SYSTEM.md)
...
Translate body/technology relations and social space into functional light, color, materials, framing and continuity; daylight and dry interiors remain valid.
...
A cyberpunk `style_route`, prompt fields, negative constraints, sound/continuity state, and QC contract.
...
- [ ] Light can be inside or outside the frame but must have an explainable source; augmentation and spatial layers remain readable.
...
- [`agents/openai.yaml`](../../../skills/cyberpunk-design/agents/openai.yaml)
- [`SKILL.md`](../../../skills/cyberpunk-design/SKILL.md)
