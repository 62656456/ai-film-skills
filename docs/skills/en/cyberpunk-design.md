...
[Runtime `SKILL.md`](../../../skills/cyberpunk-design/SKILL.md) · [Standalone ZIP](https://github.com/62656456/ai-film-skills/releases/latest/download/cyberpunk-design.zip) · [Install](../../INSTALLATION.md) · [Compatibility](../../COMPATIBILITY.md) · [Design system](../../SKILL_DESIGN_SYSTEM.md)

<!-- contract:purpose -->
## 1. Purpose

Translate cyberpunk into motivated artificial light, layered city space, body/technology relations, wet-surface behavior, material wear, and readable continuity.
...
- [ ] Neon and reflections have visible sources; city layers remain navigable; augmentation does not multiply without function.
