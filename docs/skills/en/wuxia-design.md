# wuxia-design — wuxia force, weapons, and Eastern space

| Status | Deployed |
|---|---|
| Can deliver alone | A wuxia `style_route`, action/material parameters, negative constraints, and QC contract. |
| Cannot claim alone | It does not make action wuxia by removing gravity, allowing weapon intersections, or adding weightless cloth. |

[Runtime `SKILL.md`](../../../skills/wuxia-design/SKILL.md) · [v1.3.0 historical ZIP](https://github.com/62656456/ai-film-skills/releases/download/v1.3.0/wuxia-design.zip) · [Install](../../INSTALLATION.md) · [Compatibility](../../COMPATIBILITY.md) · [Design system](../../SKILL_DESIGN_SYSTEM.md)
...
Translate wuxia into grounded force, weapon paths, footwork, cloth and hair response, architecture, Eastern materials, rhythm, sound, and continuity.
...
A wuxia `style_route`, action/material parameters, negative constraints, and QC contract.
...
- [ ] Force begins from support and travels through the body and weapon; contact, reaction, cloth, hair, dust, and landing preserve weight and direction.
...
- [`agents/openai.yaml`](../../../skills/wuxia-design/agents/openai.yaml)
- [`SKILL.md`](../../../skills/wuxia-design/SKILL.md)

**References**

- [`references/cinematic-image-direction.md`](../../../skills/wuxia-design/references/cinematic-image-direction.md)
- [`references/COMMON-12-SECTION-PROTOCOL.md`](../../../skills/wuxia-design/references/COMMON-12-SECTION-PROTOCOL.md)
- [`references/NEGATIVE-CASE-BOOK.md`](../../../skills/wuxia-design/references/NEGATIVE-CASE-BOOK.md)
- [`references/SOURCE-LEDGER.md`](../../../skills/wuxia-design/references/SOURCE-LEDGER.md)
