...
[Runtime `SKILL.md`](../../../skills/epic-design/SKILL.md) · [v1.3.0 historical ZIP](https://github.com/62656456/ai-film-skills/releases/download/v1.3.0/epic-design.zip) · [Install](../../INSTALLATION.md) · [Compatibility](../../COMPATIBILITY.md) · [Design system](../../SKILL_DESIGN_SYSTEM.md)
...
Translate epic scale into human references, terrain, formation, layered spectacle, motivated camera distance, light, material, and movement.
...
An epic-scale `style_route`, scene and movement parameters, negative constraints, and QC contract.
...
- [ ] People, terrain, architecture, formations, and atmospheric depth provide scale proof; crowds are not duplicated wallpaper and aerial moves have a dramatic purpose.
...
- [`agents/openai.yaml`](../../../skills/epic-design/agents/openai.yaml)
- [`SKILL.md`](../../../skills/epic-design/SKILL.md)
